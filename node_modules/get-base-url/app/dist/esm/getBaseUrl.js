...
export function getBaseUrl(url, prefix) {
    if (url === undefined)
        return isBrowser ? (prefix !== undefined ? window.location.origin.replace(/http:\/\/|https:\/\//, prefix) : window.location.origin) + dir : (prefix !== undefined ? prefix : "http://") + localHost;
    ...
    if (doubleSlashIndex !== -1 && doubleSlashIndex === url.indexOf(dir) - 1) {
        ...
        if (pointIndex !== -1 && pointIndex !== 0) {
            ...
            if (isBrowser) {
                if (prefix !== undefined)
                    return window.location.origin.replace(/http:\/\/|https:\/\//, prefix) + dir;
                else
